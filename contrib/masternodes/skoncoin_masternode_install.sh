...
COIN_TGZ="https://github.com/skoncoin-official/skoncoin/releases/download/v1.0.0.1/skoncoincore-1.0.0-linux${KERN_ARCH}.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-skoncoin"
  cd $CONFIGHOME
  git clone https://github.com/skoncoin-official/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
