...
Skoncoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Skoncoin Core, where everyone uses
...
pay attention to for reviewers of Skoncoin Core code.

General Skoncoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Skoncoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
