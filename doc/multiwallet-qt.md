...
Only requiring some minor changes is skoncoin.cpp.
...
Changes to skoncoin.cpp
----------------------
skoncoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
