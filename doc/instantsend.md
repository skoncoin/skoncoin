...
This mechanism has been integrated into Bitcore-Node-Skoncoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/skoncoin-official/insight-api-skoncoin#web-socket-api](https://github.com/skoncoin-official/insight-api-skoncoin#web-socket-api)
* API: [https://github.com/skoncoin-official/insight-api-skoncoin#instantsend-transactions](https://github.com/skoncoin-official/insight-api-skoncoin#instantsend-transactions)
...
By default, the Skoncoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Skoncoin Core daemon:
