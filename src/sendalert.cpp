...
2. run skoncoind with -printalert or -sendalert like this:
   /path/to/skoncoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.skoncoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Skoncoin Core:0.12.0.58/"));
