...
#define BOOST_TEST_MODULE Skoncoin Test Suite

#include "test_skoncoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_skoncoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
