    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SKOASH-light"), QVariant("light"));
    ui->theme->addItem(QString("SKOASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SKOASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SKOASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SKOASH-traditional"), QVariant("trad"));
