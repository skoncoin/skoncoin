    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Skoncoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Skoncoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  skoncoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Skoncoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SKO, 0.1 SKO, 1 SKO and 10 SKO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://skoncoin.com\">https://skoncoin.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Skoncoin Core is shutting down...") + "<br /><br />" +
