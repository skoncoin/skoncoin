    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Skoncoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Skoncoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skoncoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Skoncoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Skoncoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Skoncoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Skoncoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Skoncoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a skoncoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Skoncoin Core help message to get a list with possible Skoncoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Skoncoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Skoncoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Skoncoin Core"); // default title
