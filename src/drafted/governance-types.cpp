...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SkoncoinNetwork") type = SkoncoinNetwork;
    if(strType == "SkoncoinNetworkVariable") type = SkoncoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SkoncoinNetwork) s = "SkoncoinNetwork";
    if(type == SkoncoinNetworkVariable) s = "SkoncoinNetworkVariable";
