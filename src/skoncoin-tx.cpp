...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Skoncoin Core skoncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  skoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skoncoin transaction") + "\n" +
              "  skoncoin-tx [options] -create [commands]   " + _("Create hex-encoded skoncoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skoncoin transaction
